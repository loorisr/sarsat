...
for i = 1:num_total_modulated_bits
    ...
    if bit_val == 1
        phase_segment = current_phase * ones(1, samples_per_bit);
    else
        phase_segment_first_half = current_phase * ones(1, samples_per_half_bit);
        current_phase = -current_phase;
        phase_segment_second_half = current_phase * ones(1, samples_per_half_bit);
